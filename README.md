...
#  в этом проекте superuser: admin@sky.pro, moderator: skysaika@mail.ru, test@sky.po - контент-менеджер для vlog

Дополнительное задание, помеченное звездочкой, желательно, но не обязательно выполнять.
---
для задания звездочки
(зайду в админку создам группу контентменеджера, и далее зарегистрирую контент менеджера и дам ему эти права)
